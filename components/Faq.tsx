    ...
    <div className="flex flex-col items-center mb-[3rem] lg:my-[5rem]">
        ...
        {faq.map((faq, index) => (
            <div className="flex flex-col items-center gap-2" key={index}>
                <div className='' >
                    <h4 className="text-center py-2 bg-blue-200 rounded-lg lg:px-20 lg:text-[1.4rem] text-[1.1rem] w-[17.5rem] lg:w-[44rem] cursor-pointer" onClick={() => toggleExpand(index)}>
                        {faq.question}
                    </h4>
                </div>
                <div className='' >
